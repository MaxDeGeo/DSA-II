...
class MyCamera
{
	...
	vector3 m_v3Forward = m_v3Target - m_v3Position; //The Camera's forward vector
...
public:
	...
	*/
	...
	/*
	Creates the rotation necessary for turning the camera along the y-axis
	*/
	void ChangeYaw(float yAngle);

	/*
	Creates the rotation necessary for turning the camera along the x-axis
	*/
	void ChangePitch(float xAngle);
};
