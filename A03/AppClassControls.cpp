...
void Application::CameraRotation(float a_fSpeed)
{
	...
	m_pCamera->ChangeYaw(fAngleY * 0.20f); //Rotates around the Y axis and slows down the movement.
	m_pCamera->ChangePitch(fAngleX * -0.20f); //Rotates around the X axis and slows down the movement
}
//Keyboard
